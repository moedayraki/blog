...
Developed by Microsoft, F sharp; C Sharp's sister; is also a functional language which is imperative and object-oriented which means that it's more approachable to programmers that are new to this level.
...
Intercal was designed to make fun of the languages of the day like algol and fortan. It has an interesting choice of keywords like `please` and `mingle`. Please doesn't actually do anything but it makes you a more polite programmer.

### BrainF\*\*K

This language is well known for being extermely minimal urban lueller created breakback in college and it works by initializing an array then gives you a pointer and eight different characters to manipulate memory in that array. By reading the syntax, your brain will **\*\*** up.
