...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>The iterations remain in the loop.</td>
    </tr>
    <tr>
      <td>`$loop->count`</td>
...
Try using the `$loop` variable and let me know how you used it! For more details about Laravel, visit [Laravel's Documentation](https://laravel.com/docs/9.x)
